...
function LUI:ApplyScaling()
    ...
    RunOnAddonLoaded("Blizzard_DelvesDifficultyPicker",
        function() self:ScaleGuard(DelvesDifficultyPickerFrame, scale) end)
    RunOnAddonLoaded("Blizzard_DelvesCompanionConfiguration",
        function() self:ScaleGuard(DelvesCompanionConfigurationFrame, scale) end)
