...
function LUI:ApplyScaling()
    ...
    -- self:ScaleGuard(GameMenuFrame, scale) -- Let ElvUI take care of this one.
    ...
    RunOnAddonLoaded("Blizzard_AchievementUI", function()
        self:ScaleGuard(AchievementFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_AuctionHouseUI", function()
        self:ScaleGuard(AuctionHouseFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_BlackMarketUI", function()
        self:ScaleGuard(BlackMarketFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_Calendar", function()
        self:ScaleGuard(CalendarFrame, scale)
    end)
    ...
    RunOnAddonLoaded("Blizzard_DelvesCompanionConfiguration", function()
        self:ScaleGuard(DelvesCompanionConfigurationFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_DelvesDifficultyPicker", function()
        self:ScaleGuard(DelvesDifficultyPickerFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_EncounterJournal", function()
        self:ScaleGuard(EncounterJournal, scale)
    end)
    ...
    RunOnAddonLoaded("Blizzard_GenericTraitUI", function()
        self:ScaleGuard(GenericTraitFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_GuildBankUI", function()
        self:ScaleGuard(GuildBankFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_InspectUI", function()
        self:ScaleGuard(InspectFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_ItemInteractionUI", function()
        self:ScaleGuard(ItemInteractionFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_ItemSocketingUI", function()
        self:ScaleGuard(ItemSocketingFrame, scale)
    end)
    ...
    RunOnAddonLoaded("Blizzard_MacroUI", function()
        self:ScaleGuard(MacroFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_PlayerChoice", function()
        self:ScaleGuard(PlayerChoiceFrame, scale)
    end)
    ...
    RunOnAddonLoaded("Blizzard_Professions", function()
        self:ScaleGuard(ProfessionsFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_ProfessionsBook", function()
        self:ScaleGuard(ProfessionsBookFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_ProfessionsCustomerOrders", function()
        self:ScaleGuard(ProfessionsCustomerOrdersFrame, scale)
    end)
    RunOnAddonLoaded("Blizzard_TrainerUI", function()
        self:ScaleGuard(ClassTrainerFrame, scale, "OnShow")
    end)
    RunOnAddonLoaded("Blizzard_WeeklyRewards", function()
        self:ScaleGuard(WeeklyRewardsFrame, scale)
    end)
